...
function sidebar(){
  ...
  <div id="workspace">
      <p>WORKSPACE</p>
      <p><span><i class="fa-solid fa-briefcase"></i></span> <span id="show_login_email">Admin's
              workspace</span></p>
  </div>

  <!-- This div for admin login email -->
  <div id="login_email">
      <p><span id="show_login">Eamil of Admin</span> <span><i class="fa-solid fa-user"></i></span>
      </p>
  </div>
